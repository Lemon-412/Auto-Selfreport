...
class Client:
    ...
    def __get_data(self):
        ...
        F_State = template % (self.date, zxMatch, gnMatch, shengMatch, shiMatch[0],shiMatch[1], xianMatch[0],xianMatch[1], xxMatch, "否")
        return {
    ...
    def run(self):
        ...
        print(datetime.datetime.today()+datetime.timedelta(days=0))
...
def arg_parser():
    ...
    parser.add_argument('-d', '--date', help='上报日期',
                        ...
                        default=(datetime.date.today()+datetime.timedelta(days=0)))
